...
public class PKAnchorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options.setVideoEncodingSizeLevel(RTCConferenceOptions.VIDEO_ENCODING_SIZE_HEIGHT_480);//848*480
         ...
         */
        mRTCStreamingManager.setLocalWindowPosition(0, 0, options.getVideoEncodingWidth()/2, options.getVideoEncodingHeight()/2);
        ...
        //windowA.setAbsoluteMixOverlayRect(240,0,240,320);
